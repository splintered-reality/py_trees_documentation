...
latex_documents = [
    (master_doc, 'py_trees.tex', u'PyTrees Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'py_trees', u'PyTrees Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py_trees', u'PyTrees Documentation',
     author, 'py_trees', 'One line description of project.',
     'Miscellaneous'),
]
...
pdf_documents = [
    ('contents', u'Kobuki', u'Kobuki', author)
]
...
pdf_font_path = ['_static/fonts', '/usr/share/fonts']
